    ...
    <section id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-4">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p>
              Hi! I'm <span className="text-blue-600 font-semibold">Melat Worku</span>, a dedicated Software Engineering student with a strong passion for developing innovative and effective software solutions. I thrive on solving complex problems and transforming ideas into functional, clean, and scalable code.
            </p>
            <p>
            ...
            <div>
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-lg font-medium transition-colors group"
                download
              >
          ...
          >
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600">
                ...
                <span className="text-sm text-slate-500">Currently studying</span>
              </p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Interests</h3>
